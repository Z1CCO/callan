...
class RusTili extends StatefulWidget {
  const RusTili({super.key});

  @override
  State<RusTili> createState() => _RusTiliState();
}

class _RusTiliState extends State<RusTili> {
  ...
  void addComment() async {
    ...
    if (textData == '') {
      ...
      await chatDB.doc('rustili').collection('rustili').add({
