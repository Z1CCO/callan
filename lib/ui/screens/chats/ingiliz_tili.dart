...
class IngilizTili extends StatefulWidget {
  const IngilizTili({super.key});

  @override
  State<IngilizTili> createState() => _IngilizTiliState();
}

class _IngilizTiliState extends State<IngilizTili> {
  ...
  void addComment() async {
    ...
    if (textData == '') {
      ...
      await chatDB.doc('ingiliztili').collection('ingiliztili').add({
